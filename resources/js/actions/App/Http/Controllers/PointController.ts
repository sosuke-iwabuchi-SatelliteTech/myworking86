...
/**
* @see \App\Http\Controllers\PointController::award
* @see app/Http/Controllers/PointController.php:14
...
/**
* @see \App\Http\Controllers\PointController::show
* @see app/Http/Controllers/PointController.php:67
* @route '/api/points'
*/
