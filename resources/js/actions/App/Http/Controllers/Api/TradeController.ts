...
* @see app/Http/Controllers/Api/TradeController.php:54
* @route '/api/trades'
*/
...
* @see app/Http/Controllers/Api/TradeController.php:21
* @route '/api/trades'
*/
...
* @see app/Http/Controllers/Api/TradeController.php:42
...
* @see app/Http/Controllers/Api/TradeController.php:154
* @route '/api/trades/{id}'
*/
...
* @see app/Http/Controllers/Api/TradeController.php:170
...
* @see app/Http/Controllers/Api/TradeController.php:229
...
* @see app/Http/Controllers/Api/TradeController.php:250
...
/**
* @see \App\Http\Controllers\Api\TradeController::partners
* @see app/Http/Controllers/Api/TradeController.php:270
* @route '/api/user/trade-partners'
*/
...
const TradeController = { store, index, pendingCount, show, accept, reject, cancel, partners }
