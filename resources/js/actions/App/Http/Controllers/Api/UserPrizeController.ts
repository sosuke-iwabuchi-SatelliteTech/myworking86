...
* @see app/Http/Controllers/Api/UserPrizeController.php:18
...
* @see app/Http/Controllers/Api/UserPrizeController.php:38
* @route '/api/user/prizes'
*/
...
* @see app/Http/Controllers/Api/UserPrizeController.php:58
