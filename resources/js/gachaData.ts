...
export const GACHA_ITEMS: GachaItem[] = [
  ...
  // SR - Yokai
  { id: 'sr-y-1', name: 'てんぐ', rarity: 'SR', description: 'SRランクのようかい: 空飛ぶ天狗', imageUrl: '/gacha/sr-y-1-tengu.svg' },
  { id: 'sr-y-2', name: 'カッパ', rarity: 'SR', description: 'SRランクのようかい: 川辺の王者河童', imageUrl: '/gacha/sr-y-2-kappa.svg' },
  { id: 'sr-y-3', name: 'オニ', rarity: 'SR', description: 'SRランクのようかい: 赤き鬼', imageUrl: '/gacha/sr-y-3-oni.svg' },
  { id: 'sr-y-4', name: 'ゆきおんな', rarity: 'SR', description: 'SRランクのようかい: 吹雪の雪女', imageUrl: '/gacha/sr-y-4-yuki-onna.svg' },
  { id: 'sr-y-5', name: 'ろくろくび', rarity: 'SR', description: 'SRランクのようかい: 長首のろくろ首', imageUrl: '/gacha/sr-y-5-rokurokubi.svg' },
  { id: 'sr-y-6', name: 'うみぼうず', rarity: 'SR', description: 'SRランクのようかい: 海の怪物海坊主', imageUrl: '/gacha/sr-y-6-umibozu.svg' },
  { id: 'sr-y-7', name: 'ぬえ', rarity: 'SR', description: 'SRランクのようかい: 夜の怪鳥鵺', imageUrl: '/gacha/sr-y-7-nue.svg' },
  { id: 'sr-y-8', name: 'つちぐも', rarity: 'SR', description: 'SRランクのようかい: 忍び寄る土蜘蛛', imageUrl: '/gacha/sr-y-8-tsuchigumo.svg' },
  { id: 'sr-y-9', name: 'じょろうぐも', rarity: 'SR', description: 'SRランクのようかい: 誘惑の女郎蜘蛛', imageUrl: '/gacha/sr-y-9-jorogumo.svg' },
  { id: 'sr-y-10', name: 'わにゅうどう', rarity: 'SR', description: 'SRランクのようかい: 炎の輪入道', imageUrl: '/gacha/sr-y-10-wanyudo.svg' },
  { id: 'sr-y-11', name: 'かまいたち', rarity: 'SR', description: 'SRランクのようかい: つむじ風の鎌鼬', imageUrl: '/gacha/sr-y-11-kamaitachi.svg' },
  { id: 'sr-y-12', name: 'かさおばけ', rarity: 'SR', description: 'SRランクのようかい: 踊る傘お化け', imageUrl: '/gacha/sr-y-12-kasa-obake.svg' },
  { id: 'sr-y-13', name: 'ちょうちんおばけ', rarity: 'SR', description: 'SRランクのようかい: 笑う提灯お化け', imageUrl: '/gacha/sr-y-13-chochin-obake.svg' },
  { id: 'sr-y-14', name: 'いったんもめん', rarity: 'SR', description: 'SRランクのようかい: 空舞う一反木綿', imageUrl: '/gacha/sr-y-14-ittan-momen.svg' },
  { id: 'sr-y-15', name: 'ぬりかべ', rarity: 'SR', description: 'SRランクのようかい: 鉄壁のぬりかべ', imageUrl: '/gacha/sr-y-15-nurikabe.svg' },
  // R - Animals
